...
public class Calculator extends JFrame {
	...
	JButton clear=new JButton("删除/delete");
...
public Calculator(){
	...
	setLocation(screenSize.width/4,screenSize.height/9);//位置
	for ( i =9; i>=0; i--) {
	...
	equal.setFont(new Font("黑体",Font.PLAIN,50));
	plus.setFont(new Font("隶书",Font.PLAIN,50));
	minus.setFont(new Font("隶书",Font.PLAIN,50));
	multi.setFont(new Font("隶书",Font.PLAIN,50));
	division.setFont(new Font("隶书",Font.PLAIN,50));
